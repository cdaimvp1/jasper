...
export TEAM_DATA_DIR="C:\Users\lane_marc@lilly.com\Symphony\new_cohort\data"
export TEAM_PID_FILE="C:\Users\lane_marc@lilly.com\Symphony\new_cohort\data/team_server.pid"
export SYMPHONY_SOUL_ROOT="soul_dev"
export TEAM_PORT="8700"
export SYMPHONY_PORT="8700"
export COHORT_BASE="http://localhost:8700"
